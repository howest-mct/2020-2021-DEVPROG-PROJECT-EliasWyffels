...
namespace ProjectApi
{
    public static class Function2
    {
        ...
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "getcards/{artist}")] HttpRequest req, string artist,
            ILogger log)
        {
            ...
            TableQuery<CardEntity> rangeQuery = new TableQuery<CardEntity>()
                .Where(TableQuery.GenerateFilterCondition("PartitionKey", QueryComparisons.Equal, artist));
